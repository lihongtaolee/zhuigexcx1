...
--
-- 替换视图以便查看 `COLLATION_CHARACTER_SET_APPLICABILITY`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_BUFFER_PAGE_LRU`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_BUFFER_POOL_STATS`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_CMP_PER_INDEX_RESET`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_FT_BEING_DELETED`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_FT_DEFAULT_STOPWORD`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_FT_INDEX_CACHE`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_FT_INDEX_TABLE`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_SYS_FOREIGN_COLS`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_SYS_TABLESPACES`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_SYS_TABLESTATS`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `INNODB_TEMP_TABLE_INFO`
-- （参见下面的实际视图）
--
...
--
-- 替换视图以便查看 `REFERENTIAL_CONSTRAINTS`
-- （参见下面的实际视图）
--
...
--
-- 视图结构 `COLLATION_CHARACTER_SET_APPLICABILITY`
--
...
--
-- 视图结构 `INNODB_CMP_PER_INDEX_RESET`
--
...
--
-- 视图结构 `INNODB_FT_DEFAULT_STOPWORD`
--
