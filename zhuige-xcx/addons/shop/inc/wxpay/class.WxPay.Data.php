...
require_once( ZHUIGE_SHOP_BASE_DIR . 'includes/wxpay/class.WxPay.Config.php' );
require_once( ZHUIGE_SHOP_BASE_DIR . 'includes/wxpay/class.WxPay.Exception.php' );
...
}_exists('device_info', $this->values);
	}
...
}_exists('out_trade_no', $this->values);
	}
...
}_exists('spbill_create_ip', $this->values);
	}
...
}_exists('time_start', $this->values);
	}
...
}_exists('time_expire', $this->values);
	}
...
}_exists('notify_url', $this->values);
	}
...
}_exists('trade_type', $this->values);
	}
