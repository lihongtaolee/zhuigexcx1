	...
	<view class="content">
		...
		<view class="zhuige-comment-list">
			<view class="zhuige-comment-header">
				<text>用户评论</text>
				<uni-icons @click="clickLink('/pages/shop/comment?goods_id=' + goods_id)" type="chatbubble"
					size="24"></uni-icons>
			</view>
		...
		<view class="zhuige-goods-bar">
			...
			<view class="zhuige-goods-btn">
				...
				<view @click="clickLink('/pages/shop/order_confirm?goods_id=' + goods.id)">立即购买</view>
			</view>
		</view>
	</view>
</template>
	...
	export default {
		...
		onShareAppMessage() {
			return {
				...
				path: 'pages/shop/detail?goods_id=' + this.goods_id
			};
		},
